        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Form->Html->link(__('View'),['action'=>'view',$checkin->id],['class'=>'btn bg-view-btn py-0 me-2'])?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $checkin->id], ['confirm' => __('Are you sure you want to delete # {0}?', $checkin->id),'class'=>'btn bg-delete-btn py-0 me-2']) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
